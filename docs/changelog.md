<!-- This file mirrors CHANGELOG.md at the repo root. Keep in sync manually or via CI. -->
...
> **Note:** this mirror file is missing the `[0.8.1]` and `[0.9.0]` entries present in the root `CHANGELOG.md`; the manual sync drifted before this release. Backfill from the root changelog separately.
